      ...
      <Box display='flex' flexwrap="wrap" >
        ...
        >
          <Grid
            ...
            className="gridSpace"
          >
            <Typography align="left" variant="h6" component="h3">Good luck, {this.props.userName}!</Typography>
            <Typography align="right" variant="subtitle1" component="h3" className="timer"><AccessTime />Your score: {this.state.seconds} seconds</Typography>
          </Grid>
          <Grid
            container
            direction="row"
            ...
            className="gridSpace"
          >
            <Typography align="left" variant="caption text">Pick up the right cards</Typography>
            <Typography align="right" variant="caption text">The faster the better!</Typography>
          </Grid>
          <section>
          ...
          <Typography align="left" variant="caption text" className="gridSpace">..and drop them here to make the logo great again!</Typography>
          <section>
